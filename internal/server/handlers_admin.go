...
func (s *Server) scheduleManagerRestart(newVer string) {
	...
	// v1.5.34 M3: 动态获取当前 manager 路径, 不再硬编码 /opt/ddns-manager/
...
# auto-generated by ddns-manager v1.5.34 — self-restart after binary upload
...
rm -f %s
`, binDir, newBin, curExe, curExe, scriptPath)
